...
namespace TabPermi
{
    public class TabPermi_CALL
    {
        ...
        public void TabPermi_AUTORIZADO()
        {
            ...
            if (!VerFILES())
            {
                try
                {
                    if (_WenCrypt == "TabPermi16Wenemy3156!.350?°")
                    {
                        ...
                        {
                            TabPermi Call = new TabPermi();
                            Call._Login_LojaID_TabPermi = _Login_CryptCode;
                            Call._Login_UsuarioID_TabPermi = _Login_CryptDesc;
