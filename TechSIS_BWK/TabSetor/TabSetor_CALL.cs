...
namespace TabSetor
{
    public class TabSetor_CALL
    {
        ...
        public void TabSetor_AUTORIZADO()
        {
            ...
            if (!VerFILES())
            {
                try
                {
                    if (_WenCrypt == "TabSetor19Wenemy3156!.350?°")
                    {
                        ...
                        {
                            TabSetor Call = new TabSetor();
                            Call._Login_LojaID_TabSetor = _Login_CryptCode;
                            Call._Login_UsuarioID_TabSetor = _Login_CryptDesc;
