...
namespace TabCfope
{
    internal class TabCfope_Histórico
    {
        ...
        public void HIS_PopularHISTORICO(TextBox txtUsuarioHis, Control Retorno, DataGridView Dgv_Histórico, MaskedTextBox mtbData1His, MaskedTextBox mtbData2His, ComboBox comIDHis, Panel panUpAb5)
        {
            ...
            String Select_CMD = String.Format("SELECT TipLan_HIS,Usuari_HIS,Apelid_USU,ObsLa1_HIS,ObsLa2_HIS,DtLanc_HIS FROM TabHisto INNER JOIN TabUsuar ON TabHisto.Usuari_HIS = TabUsuar.Sequen_USU WHERE Prog01_HIS = '010300'");
