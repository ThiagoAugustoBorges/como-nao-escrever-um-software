...
namespace TabCfope
{
    public class TabCfope_CALL
    {
        ...
        public void TabCfope_AUTORIZADO()
        {
            ...
            if (!VerFILES())
            {
                try
                {
                    if (_WenCrypt == "TabCfope3Wenemy3156!.350?°")
                    {
                        ...
                        {
                            TabCfope Call = new TabCfope();
                            Call._Login_LojaID_TabCfope = _Login_CryptCode;
                            Call._Login_UsuarioID_TabCfope = _Login_CryptDesc;
