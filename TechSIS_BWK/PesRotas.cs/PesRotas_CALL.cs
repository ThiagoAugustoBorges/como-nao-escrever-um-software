...
namespace PesRotas.cs
{
    public class PesRotas_CALL
    {
        ...
        public void PesRotas_AUTORIZADO()
        {
            ...
            if (!VerFILES())
            {
                try
                {
                    if (_WenCrypt == "PesRotas18Wenemy3156!.350?°")
                    {
                        ...
                        {
                            PesRotas Call = new PesRotas();
                            Call._Login_LojaID_PesRotas = _Login_CryptCode;
                            Call._Login_UsuarioID_PesRotas = _Login_CryptDesc;
                            Call.ShowDialog();
