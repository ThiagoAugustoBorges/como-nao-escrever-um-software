...
{
    internal partial class PesPaise : Form
    {
        public PesPaise()
        {
            InitializeComponent();
        ...
        public string _Login_LojaID_PesPaise { get; set; }
        public string _Login_UsuarioID_PesPaise { get; set; }


        public string _ResultPesquisa { get; set; }

        //LOAD DO FORM
        private void PesPaise_Load(object sender, EventArgs e)
        {
            PesPaise_MET MET = new PesPaise_MET();

            //VERIFICA SE É PARA GRAVAR OS FILTROS
            MET.cheFILTROSChecked(cheFiltrosPES, _Login_LojaID_PesPaise);
            ...
            CFG.Cfg_SelecionaCorConfig(Controles, _Login_LojaID_PesPaise);
        ...
        //TECLAS DE ATALHO
        private void PesPaise_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.F1:
        ...
        //GRAVA OS FILTROS
        private void PesPaise_FormClosing(object sender, FormClosingEventArgs e)
        {
            PesPaise_MET MET = new PesPaise_MET();
        ...
        private void btnPesquisar_Click(object sender, EventArgs e)
        {
            //EXECUTA A PESQUISA
            PesPaise_MET MET = new PesPaise_MET();
            MET.Pesquisa_EXEC(_Login_LojaID_PesPaise, rabAlfabetico, rabNumerico, rabTodos, rabTOP, nupQtResultados, Dgv_Pesquisa, txtDescri);
