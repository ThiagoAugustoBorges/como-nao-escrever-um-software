...
namespace TabRotas
{
    public class TabRotas_CALL
    {
        ...
        public void TabRotas_AUTORIZADO()
        {
            ...
            if (!VerFILES())
            {
                try
                {
                    if (_WenCrypt == "TabRotas18Wenemy3156!.350?°")
                    {
                        ...
                        {
                            TabRotas Call = new TabRotas();
                            Call._Login_LojaID_TabRotas = _Login_CryptCode;
                            Call._Login_UsuarioID_TabRotas = _Login_CryptDesc;
                            Call._Tipo = Convert.ToInt32(_Login_Crypt01);
