...
namespace PesCfope.cs
{
    public class PesCfope_CALL
    {
        ...
        public void PesCfope_AUTORIZADO()
        {
            ...
            if (!VerFILES())
            {
                try
                {
                    if (_WenCrypt == "PesCfope3Wenemy3156!.350?°")
                    {
                        ...
                        {
                            PesCfope Call = new PesCfope();
                            Call._Login_LojaID_PesCfope = _Login_CryptCode;
                            Call._Login_UsuarioID_PesCfope = _Login_CryptDesc;
                            Call.ShowDialog();
