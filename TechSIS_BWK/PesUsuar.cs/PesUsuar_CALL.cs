...
namespace PesUsuar.cs
{
    public class PesUsuar_CALL
    {
        ...
        public void PesUsuar_AUTORIZADO()
        {
            ...
            if (!VerFILES())
            {
                try
                {
                    if (_WenCrypt == "PesUsuar21Wenemy3156!.350?°")
                    {
                        ...
                        {
                            PesUsuar Call = new PesUsuar();
                            Call._Login_LojaID_PesUsuar = _Login_CryptCode;
                            Call._Login_UsuarioID_PesUsuar = _Login_CryptDesc;
                            Call.ShowDialog();
