...
namespace TabUsuar
{
    internal class TabUsuar_FILTROS
    {
        #region CRIPTOGRAFIA
        ...
        public void GravarFILTROS(CheckBox cheFiltrosPES, CheckBox cheFiltrosIMP, RadioButton rabNumerico, RadioButton rabAlfabetica, RadioButton rabTodos, RadioButton rabTOP, NumericUpDown nupQtResultados, ComboBox comPesSituacao, RadioButton rabOrdemNumerica, RadioButton rabOrdemAlfabetica, RadioButton rabRPV, RadioButton rabWORD, RadioButton rabEXCEL, RadioButton rabTXT, ComboBox comSituacaoIMP, TextBox txtCaminhoRel, CheckBox cheVoltarLix, ComboBox comPesPermissao, ComboBox comPermissaoIMP, CheckBox cheImpApelid, RadioButton rabOrdemAlfabeticaApelid)
        {
            ...
            try
            {
                ...
                GerarXML.WriteElementString("comPesSituacao", WenProtects(comPesSituacao.SelectedIndex.ToString()));
                GerarXML.WriteElementString("comPesPermissao", WenProtects(comPesPermissao.SelectedIndex.ToString()));
                //IMPRESSÃO
                ...
                GerarXML.WriteElementString("rabOrdemAlfabeticaApelid", WenProtects(rabOrdemAlfabeticaApelid.Checked.ToString()));
                ...
                GerarXML.WriteElementString("comPermissaoIMP", WenProtects(comPermissaoIMP.SelectedIndex.ToString()));
        ...
        public void CarregaFILTROS(CheckBox cheFiltrosPES, CheckBox cheFiltrosIMP, RadioButton rabNumerico, RadioButton rabAlfabetica, RadioButton rabTodos, RadioButton rabTOP, NumericUpDown nupQtResultados, ComboBox comPesSituacao, RadioButton rabOrdemNumerica, RadioButton rabOrdemAlfabetica, RadioButton rabRPV, RadioButton rabWORD, RadioButton rabEXCEL, RadioButton rabTXT, ComboBox comSituacaoIMP, TextBox txtCaminhoRel, CheckBox cheVoltarLix, ComboBox comPesPermissao, ComboBox comPermissaoIMP, CheckBox cheImpApelid, RadioButton rabOrdemAlfabeticaApelid)
        {
            string Patch = @"..\Log\TabUsuar.xml";
            try
            {
                if (File.Exists(Patch))
                {
                    ...
                    XmlNode comPesPermissao_xml = LerXML.DocumentElement.SelectSingleNode("comPesPermissao");
                    ...
                    XmlNode comPermissaoIMP_xml = LerXML.DocumentElement.SelectSingleNode("comPermissaoIMP");
                    ...
                    string _comPesSituacao = WenDisprotects(comPesSituacao_xml.InnerText.ToString());
                    string _comPesPermissao = WenDisprotects(comPesPermissao_xml.InnerText.ToString());
                    #endregion
                    ...
                    string _rabOrdemAlfabeticaApelid = WenDisprotects(rabOrdemAlfabeticaApelid_xml.InnerText.ToString());
                    string _comSituacaoIMP = WenDisprotects(comSituacaoIMP_xml.InnerText.ToString());
                    string _comPermissaoIMP = WenDisprotects(comPermissaoIMP_xml.InnerText.ToString());
                    ...
                    if (_cheFiltrosPES == "True")
                    {
                        ...
                        comPesPermissao.SelectedIndex = Convert.ToInt32(_comPesPermissao);
                    }
                    else
                    {
                        ...
                        comPesPermissao.SelectedIndex = -1;
                    }
                    #endregion
                    ...
                    if (_cheFiltrosIMP == "True")
                    {
                        ...
                        comPermissaoIMP.SelectedIndex = Convert.ToInt32(_comPermissaoIMP);
                    ...
                    else
                    {
                        ...
                        comPermissaoIMP.SelectedIndex = -1;
