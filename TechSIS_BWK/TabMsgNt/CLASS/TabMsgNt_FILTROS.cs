...
namespace TabMsgNt
{
    internal class TabMsgNt_FILTROS
    {
        #region CRIPTOGRAFIA
        ...
        public void GravarFILTROS(CheckBox cheFiltrosPES, CheckBox cheFiltrosIMP, RadioButton rabNumerico, RadioButton rabAlfabetico, RadioButton rabTodos, RadioButton rabTOP, NumericUpDown nupQtResultados, ComboBox comPesEmpresa, RadioButton rabOrdemNumerica, RadioButton rabOrdemAlfabetica, RadioButton rabRPV, RadioButton rabWORD, RadioButton rabEXCEL, RadioButton rabTXT, ComboBox comImpEmpresa, TextBox txtCaminhoRel)
        {
            ...
            try
            {
                ...
                GerarXML.WriteElementString("comPesEmpresa", WenProtects(comPesEmpresa.SelectedIndex.ToString()));
                //IMPRESSÃO
                ...
                GerarXML.WriteElementString("comImpEmpresa", WenProtects(comImpEmpresa.SelectedIndex.ToString()));
        ...
        public void CarregaFILTROS(CheckBox cheFiltrosPES, CheckBox cheFiltrosIMP, RadioButton rabNumerico, RadioButton rabAlfabetico, RadioButton rabTodos, RadioButton rabTOP, NumericUpDown nupQtResultados, ComboBox comPesEmpresa, RadioButton rabOrdemNumerica, RadioButton rabOrdemAlfabetica, RadioButton rabRPV, RadioButton rabWORD, RadioButton rabEXCEL, RadioButton rabTXT, ComboBox comImpEmpresa, TextBox txtCaminhoRel)
        {
            ...
            try
            {
                if (File.Exists(Patch))
                {
                    ...
                    XmlNode comPesEmpresa_xml = LerXML.DocumentElement.SelectSingleNode("comPesEmpresa");
                    ...
                    XmlNode comImpEmpresa_xml = LerXML.DocumentElement.SelectSingleNode("comImpEmpresa");
                    ...
                    string _comPesEmpresa = WenDisprotects(comPesEmpresa_xml.InnerText.ToString());
                    #endregion
                    ...
                    string _comImpEmpresa = WenDisprotects(comImpEmpresa_xml.InnerText.ToString());
                    ...
                    if (_cheFiltrosPES == "True")
                    {
                        ...
                        comPesEmpresa.SelectedIndex = Convert.ToInt32(_comPesEmpresa);
                    }
                    else
                    {
                    ...
                    if (_cheFiltrosIMP == "True")
                    {
                        ...
                        comImpEmpresa.SelectedIndex = Convert.ToInt32(_comImpEmpresa);
