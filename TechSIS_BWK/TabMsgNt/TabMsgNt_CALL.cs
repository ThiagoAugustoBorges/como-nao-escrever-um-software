...
namespace TabMsgNt
{
    public class TabMsgNt_CALL
    {
        ...
        public void TabMsgNt_AUTORIZADO()
        {
            ...
            if (!VerFILES())
            {
                try
                {
                    if (_WenCrypt == "TabMsgNt13Wenemy3156!.350?°")
                    {
                        ...
                        {
                            TabMsgNt Call = new TabMsgNt();
                            Call._Login_LojaID_TabMsgNt = _Login_CryptCode;
                            Call._Login_UsuarioID_TabMsgNt = _Login_CryptDesc;
