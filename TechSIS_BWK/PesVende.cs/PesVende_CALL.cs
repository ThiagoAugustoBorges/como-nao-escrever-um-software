...
namespace PesVende.cs
{
    public class PesVende_CALL
    {
        ...
        public void PesVende_AUTORIZADO()
        {
            ...
            if (!VerFILES())
            {
                try
                {
                    if (_WenCrypt == "PesVende21Wenemy3156!.350?°")
                    {
                        ...
                        {
                            PesVende Call = new PesVende();
                            Call._Login_LojaID_PesVende = _Login_CryptCode;
                            Call._Login_UsuarioID_PesVende = _Login_CryptDesc;
                            Call.ShowDialog();
