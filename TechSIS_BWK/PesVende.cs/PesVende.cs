...
{
    internal partial class PesVende : Form
    {
        public PesVende()
        {
            InitializeComponent();
        ...
        public string _Login_LojaID_PesVende { get; set; }
        public string _Login_UsuarioID_PesVende { get; set; }

        public string _ResultPesquisa { get; set; }


        //LOAD DO FORMULARIO
        private void PesVende_Load(object sender, EventArgs e)
        {
            PesVende_MET MET = new PesVende_MET();

            //VERIFICA SE É PARA GRAVAR OS FILTROS
            MET.cheFILTROSChecked(cheFiltrosPES, _Login_LojaID_PesVende);
            ...
            CFG.Cfg_SelecionaCorConfig(Controles, _Login_LojaID_PesVende);
            ...
            comComiss.SelectedIndexChanged -= new EventHandler(comComiss_SelectedIndexChanged);
            comContrato.SelectedIndexChanged -= new EventHandler(comContrato_SelectedIndexChanged);
            #endregion
            //CARREGA OS FILTROS
        ...
        //TECLAS DE ATALHO
        private void PesVende_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.F1:
        ...
        //GRAVA OS FILTROS
        private void PesVende_FormClosing(object sender, FormClosingEventArgs e)
        {
            PesVende_MET MET = new PesVende_MET();
        ...
        private void txtCidadeCod_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.F6)
            {
                ...
                Call._Login_CryptCode = _Login_LojaID_PesVende;
                Call._Login_CryptDesc = _Login_UsuarioID_PesVende;
        ...
        {
            PesVende_MET MET = new PesVende_MET();
            MET.Pesquisa_EXEC(_Login_LojaID_PesVende, rabAlfabetico, rabNumerico, rabTodos, rabTOP, nupQtResultados, Dgv_Pesquisa, comStatus, txtCidadeCod, txtCidadeDesc, txtDescri, txtFantasia, txtCpfCnpj, txtEmpresa, comComiss, comContrato);
        ...
        private void comComiss_SelectedIndexChanged(object sender, EventArgs e)
        {
            //EXECUTA A PESQUISA
            PesVende_MET MET = new PesVende_MET();
            MET.Pesquisa_EXEC(_Login_LojaID_PesVende, rabAlfabetico, rabNumerico, rabTodos, rabTOP, nupQtResultados, Dgv_Pesquisa, comStatus, txtCidadeCod, txtCidadeDesc, txtDescri, txtFantasia, txtCpfCnpj, txtEmpresa, comComiss, comContrato);
        ...
        private void comContrato_SelectedIndexChanged(object sender, EventArgs e)
        {
            //EXECUTA A PESQUISA
            PesVende_MET MET = new PesVende_MET();
            MET.Pesquisa_EXEC(_Login_LojaID_PesVende, rabAlfabetico, rabNumerico, rabTodos, rabTOP, nupQtResultados, Dgv_Pesquisa, comStatus, txtCidadeCod, txtCidadeDesc, txtDescri, txtFantasia, txtCpfCnpj, txtEmpresa, comComiss, comContrato);
