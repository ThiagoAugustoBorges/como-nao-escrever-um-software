...
namespace TabClien
{
    public class TabClien_CALL
    {
        ...
        public void TabClien_AUTORIZADO()
        {
            ...
            if (!VerFILES())
            {
                try
                {
                    if (_WenCrypt == "TabClien3Wenemy3156!.350?°")
                    {
                        ...
                        {
                            TabClien Call = new TabClien();
                            Call._Login_LojaID_TabClien = _Login_CryptCode;
                            Call._Login_UsuarioID_TabClien = _Login_CryptDesc;
                            Call._Login_LojaDesc_TabClien = _Login_Crypt01;
                            Call._Login_UsuarioDesc_TabClien = _Login_Crypt02;
