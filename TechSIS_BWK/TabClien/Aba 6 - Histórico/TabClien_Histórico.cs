...
namespace TabClien
{
    internal class TabClien_Histórico
    {
        ...
        public void HIS_SelecionaDados(MaskedTextBox mtbData1His, MaskedTextBox mtbData2His, TextBox txtUsuarioHist, TextBox txtUsuario, string UsuarioDescri, TextBox txtUsuarioDescHis)
        {
            ...
            txtUsuarioDescHis.Text = UsuarioDescri;
        }
        ...
        public void HIS_PopularHISTORICO(TextBox txtUsuarioHis, Control Retorno, DataGridView Dgv_Histórico, MaskedTextBox mtbData1His, MaskedTextBox mtbData2His, ComboBox comIDHis, Panel panUpAb5)
        {
            ...
            bool Val_1 = MET.MET_VerificaDATA(mtbData1His, mtbData1His);
            if (!Val_1)
            { }
            else
            { Dgv_Histórico.Rows.Clear(); return; }
            bool Val_2 = MET.MET_VerificaDATA(mtbData2His, mtbData2His);
            if (!Val_2)
            { }
            else
            { Dgv_Histórico.Rows.Clear(); return; }
            ...
            String Select_CMD = String.Format("SELECT TipLan_HIS,Usuari_HIS,Apelid_USU,ObsLa1_HIS,ObsLa2_HIS,DtLanc_HIS FROM TabHisto INNER JOIN TabUsuar ON TabHisto.Usuari_HIS = TabUsuar.Sequen_USU WHERE Prog01_HIS = '020100'");
