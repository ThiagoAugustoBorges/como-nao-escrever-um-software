...
namespace AplReport
{
    public class AplReport_CALL
    {
        ...
        public void AplReport_AUTORIZADO()
        {
            ...
            if (!VerFILES())
            {
                try
                {
                    if (_WenCrypt == "AplReport18Wenemy3156!.350?°")
                    {
                        ...
                        {
                            AplReport Call = new AplReport();
                            Call.Seq_Loja = _Login_CryptCode;
                            Call.Seq_Usua = _Login_CryptDesc;
