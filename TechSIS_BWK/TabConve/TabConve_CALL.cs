...
namespace TabConve
{
    public class TabConve_CALL
    {
        ...
        public void TabConve_AUTORIZADO()
        {
            ...
            if (!VerFILES())
            {
                try
                {
                    if (_WenCrypt == "TabConve3Wenemy3156!.350?°")
                    {
                        ...
                        {
                            TabConve Call = new TabConve();
                            Call._Login_LojaID_TabConve = _Login_CryptCode;
                            Call._Login_UsuarioID_TabConve = _Login_CryptDesc;
