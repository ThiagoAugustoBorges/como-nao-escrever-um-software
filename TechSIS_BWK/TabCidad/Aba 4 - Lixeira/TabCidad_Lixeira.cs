...
namespace TabCidad
{
    internal class TabCidad_Lixeira
	{
        ...
        public void Lix_POPULAR(DataGridView Dgv_Lixeira, CheckBox cheVoltarLix, TabControl TabControl, TabPage Tp1)
        {
            ...
            string LixeiraPOP = "SELECT Sequen_CID,Descri_CID,UfFede_CID FROM TabCidad WHERE Status_CID = 3";
            ...
            try
            {
                ...
                if (Dr.HasRows)
                {
                    while (Dr.Read())
                    {
                        ...
                        Dgv_Lixeira.Rows.Add(Sequen_CID, Descri_CID, UfFede_CID);
                    }
                }
                else
                {
        ...
        public void Lix_RESTAURAR(DataGridView Dgv_Lixeira, CheckBox cheVoltarLix, TabControl TabControl, TabPage Tp1, TextBox txtUsuario, Button btnGravar, TextBox txtMESTRE, MethodInvoker CamposDisable, TextBox txtCodigo, Button btnIncluir)
        {
            ...
            if (Restau == DialogResult.Yes)
            {
                ...
                string _ComandoRESTAU = "UPDATE TabCidad SET Status_CID = 1 WHERE Sequen_CID = @Sequen";
                string StringComandoRESTAU_HIST = "INSERT INTO TabHisto (Sequen_HIS,Prog01_HIS,TipLan_HIS,ObsLa1_HIS,ObsLa2_HIS,Usuari_HIS,DtLanc_HIS) VALUES (@SequenHIS,'010200','RESTAURAÇÃO',@ObsLa1,@ObsLa2,@Usuari,@DtCada)";
