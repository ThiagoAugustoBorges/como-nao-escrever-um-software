...
namespace TabCidad
{
    public class TabCidad_CALL
    {
        ...
        public void TabCidad_AUTORIZADO()
        {
            ...
            if (!VerFILES())
            {
                ...
                try
                {
                    if (_WenCrypt == "TabCidad3Wenemy3156!.350?°")
                    {
                        ...
                        {
                            TabCidad Call = new TabCidad();
                            Call._Login_LojaID_TabCidad = _Login_CryptCode;
                            Call._Login_UsuarioID_TabCidad = _Login_CryptDesc;
