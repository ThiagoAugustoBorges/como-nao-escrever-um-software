...
namespace AplUsuaAt
{
    public class AplUsuaAt_CALL
    {
        ...
        public void AplUsuaAt_AUTORIZADO()
        {
            ...
            if (!VerFILES())
            {
                try
                {
                    if (_WenCrypt == "AplUsuaAt21Wenemy3156!.350?°")
                    {
                        ...
                        {
                            AplUsuaAt Call = new AplUsuaAt();
                            Call._Login_LojaID_AplUsuaAt = _Login_CryptCode;
                            Call._Login_UsuarioID_AplUsuaAt = _Login_CryptDesc;
                            Call._Login_UsuarioDesc_AplUsuaAt = _Login_Crypt02;
