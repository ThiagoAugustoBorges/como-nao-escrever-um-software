...
namespace PesMunic.cs
{
    public class PesMunic_CALL
    {
        ...
        //RECEBE A UF
        public string _UF_Call { get; set; }
        ...
        public void PesMunic_AUTORIZADO()
        {
            ...
            if (!VerFILES())
            {
                try
                {
                    if (_WenCrypt == "PesMunic13Wenemy3156!.350?°")
                    {
                        ...
                        {
                            PesMunic Call = new PesMunic();
                            Call._Login_LojaID_PesMunic = _Login_CryptCode;
                            Call._Login_UsuarioID_PesMunic = _Login_CryptDesc;
                            Call._UF = _UF_Call;
                            Call.ShowDialog();
