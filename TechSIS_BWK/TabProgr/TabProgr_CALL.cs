...
namespace TabProgr
{
    public class TabProgr_CALL
    {
        ...
        public void TabProgr_AUTORIZADO()
        {
            ...
            if (!VerFILES())
            {
                try
                {
                    if (_WenCrypt == "TabProgr16Wenemy3156!.350?°")
                    {
                        ...
                        {
                            TabProgr Call = new TabProgr();
                            Call._Login_LojaID_TabProgr = _Login_CryptCode;
                            Call._Login_UsuarioID_TabProgr = _Login_CryptDesc;
